...
export function registerEvolveDrifter(server: McpServer) {
  server.tool(
    "evolve_drifter_personality",
    "Evolve your active drifter's personality and trait based on its recent journey log. MUST adhere strictly to Universal Values.",
    schema.shape,
    async (input) => {
